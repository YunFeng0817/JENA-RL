...
public class QueryEngineTDB extends QueryEngineMain {
    ...
    public QueryIterator eval(Op op, DatasetGraph dsg, Binding input, Context context) {
        ...
        // Op is quad'ed by now but there still may be some (graph ....) forms e.g.
        // paths
    ...
    protected static class QueryEngineFactoryTDB implements QueryEngineFactory {
        ...
        protected DatasetGraphTDB dsgToQuery(DatasetGraph dataset) {
            ...
            throw new TDBException(
                    "Internal inconsistency: trying to execute query on unrecognized kind of DatasetGraph: "
                            + Lib.className(dataset));
        }
