...
public class DQN {
    ...
    public static void cartPole() throws IOException {
        ...
        try {
            ...
            System.out.print(
                    "To run this example, download and start the gym-http-api repo found at https://github.com/openai/gym-http-api.");
        }
        // define the training
    ...
    public static void loadCartpole() throws IOException {
        ...
        // showcase serialization by using the trained agent on a new similar mdp (but
        // render it this time)
